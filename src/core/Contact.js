            ...
            <div className="col-xs-12 col-sm-6">
                <div className="card my-4">
                    <div className="card-header text-center bg-success">
                        ...
                        <p className="text-justify m-3 text-white">Founded in 2022, Traveler is India’s leading online travel marketplace bringing both the traveler and expert Travel-Agents on a common platform.</p>
                    </div>
                    <div className="card-body">
                        <ul className="list-group">
                            ...
                            <li className="list-group-item">Traveler Agency</li>
                            <li className="list-group-item ">Abohar, Punjab</li>
