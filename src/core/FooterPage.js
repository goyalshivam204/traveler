      ...
      <MDBContainer className="mt-5 mb-4 text-center text-md-left">
        <MDBRow className="mt-3">
          <MDBCol md="3" lg="4" xl="3" className="mb-4 dark-grey-text">
            ...
            A Solution that activates the traveling bug with vibrant imagery and working on to continuously provides enjoyable quality excursions/trips on time and on budget.We Focus on  developing  enthusiastically satisfied customers all of the time.
            </p>
          </MDBCol>
          ...
          <MDBCol md="4" lg="3" xl="3" className="mb-4 dark-grey-text">
            ...
            <hr className="deep-purple accent-2 mb-4 mt-0 d-inline-block mx-auto" style={{ width: "60px" }} />
            <p>
              <i className="fa fa-home mr-3" /> Abohar,Punjab, India
            </p>
            <p>
              <i className="fa fa-envelope mr-3" /> info@traveler.com
            </p>
            <p>
              <i className="fa fa-phone mr-3" /> + 01 234 567 xx
            </p>
            <p>
              <i className="fa fa-print mr-3" /> + 01 234 567 xx
            </p>
          </MDBCol>
        </MDBRow>
      </MDBContainer>
